//
//  UIMovieViewController.swift
//  HBO
//
//  Created by Malithi Sathsarani Mallawaarachchi on 2/2/20.
...
class UIMovieViewController: UIViewController , UITableViewDelegate,UITableViewDataSource {
